...
public class FileUtils
{
	...
	{
		URL resourcePath = FileUtils.class.getResource(inResourceName);
	...
	{
		InputStream resourceStream = FileUtils.class.getResourceAsStream(inResourceName);
	...
	/**
	 * Create folder named infolderName relative to inParentFolder.
	 */
