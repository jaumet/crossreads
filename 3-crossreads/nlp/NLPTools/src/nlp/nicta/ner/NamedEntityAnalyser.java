...
import nlp.nicta.ner.classifier.NameClassifier;
import nlp.nicta.ner.extractor.NameExtractor;
...
public class NamedEntityAnalyser {
	...
	public static void main(String[] args) throws Exception {
		...
		String filename = "files/article1.txt";
		if(args.length >= 1) {
			filename = args[0];
		}
		
		// Extract named entities
		NERResultSet results = nea.process(ReadFileAsString(filename));
