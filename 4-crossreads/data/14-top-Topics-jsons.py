...
topics_list = [1, 3, 5, 6, 7, 8, 9, 12, 14, 15, 17, 18, 19, 20, 23, 24, 25, 26, 27, 33, 34, 35, 36, 37, 38, 39, 40, 42, 45, 46, 49, 50, 53, 57, 58, 59, 60, 61, 62, 63, 65, 66, 68, 69, 70, 71, 72, 74, 75, 77, 78, 79, 80, 83, 84, 85, 87, 89, 90, 93, 94, 95, 96, 97] ## 64 topics out of 100
      ...
      for pages in mydiary[0]["pages"]:
          ...
          for topics in pages["topics"]:
            if float(topics[1]) >= TOPIC_THERSHOLD: 
              ...
              for thetopic in topicsjson:
                if topics[0] == thetopic["mallet_ids_inluded"] and str(thetopic["tid"])[0] == str(TGid):
