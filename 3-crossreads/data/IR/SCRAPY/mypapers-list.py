...
print "Len with no duplcates:"
print len(list(set(papers)))



clean = []
#clean = list(set(papers))
#print "Len list clean"
#print len(clean)
...
for i in papers:
	myurl = str(p.findall(i))[2:-2]
	if (len(myurl)==1):
		clean11.append(myurl)
	elif (len(myurl)==2):
		clean12.append(myurl)
	elif (len(myurl)==3):
		clean13.append(myurl)
	else:
		clean.append(myurl)
clean.sort()
clean11.sort()
